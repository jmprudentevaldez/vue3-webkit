<template>
  ...
  <div class="mb-1 mt-8 flex w-full justify-end lg:mt-8">
    ...
    >
      <template #icon>
        <font-awesome-icon icon="fa-solid fa-circle-check" class="mr-1.5 h-3 w-3 font-light" />
      </template>
...
const getId = usePrependOrAppendOnce('verify-account-page')
